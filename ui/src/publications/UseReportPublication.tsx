...
function ReportPublicationForm({ publication }: ReportPublicationFormProps) {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const additionalComments =
      (formData.get("additionalComments") as string | null) ?? never();
      ...
      <div>
        ...
        <select name="reason" disabled={loading}>
          ...
          <optgroup label="Sensitive content">
            <option value={ReportReason.NUDITY}>
          ...
          <optgroup label="Spam">
            ...
            <option value={ReportReason.MISUSE_HASHTAGS}>
              Misuse of hashtags
            </option>
            <option value={ReportReason.UNRELATED}>Unrelated</option>
            <option value={ReportReason.REPETITIVE}>Repetitive</option>
            <option value={ReportReason.FAKE_ENGAGEMENT}>
              Fake engagement
            </option>
            <option value={ReportReason.MANIPULATION_ALGO}>
