...
contract FunctionsCoordinator is
    OCR2Base,
    ...
    FunctionsBilling
{
    ...
    function getThresholdPublicKey()
        external
        view
        override
    ...
    function _report(
        ...
        (requestIds, results, errors, onchainMetadata, offchainMetadata) = abi
        ...
        for (uint256 i = 0; i < requestIds.length; ++i) {
            FunctionsResponse.FulfillResult result = FunctionsResponse
                .FulfillResult(
                    _fulfillAndBill(
                        requestIds[i],
                        results[i],
